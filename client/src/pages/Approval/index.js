...
const AuthRequest = ({ authRequest, scrollPosition }) => {
  ...
  return (
    <div className="flex min-w-min min-h-0 p-12 justify-center items-center bg-gray-100">
      <div className="justify-center items-center w-1/4 min-w-min bg-white rounded-lg py-2 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-125 cursor-pointer">
